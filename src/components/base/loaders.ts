...
type LoaderFunction = (path: string, callback: LoaderCallback, file_loader: FileLoader, is_file: boolean) => void
...
const loader_exists = (loader_name: string): boolean => loaders[loader_name] !== undefined

const with_loader =
  (loader_name: string, file_loader: FileLoader, is_file: boolean) =>
  (source: string) =>
