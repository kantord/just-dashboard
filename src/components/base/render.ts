...
const call_render_function = (args: ComponentConfig, instance_args: ComponentArgs, selection: D3Selection, element: D3Selection) =>
  (data: unknown) => {
    try {
...
const execute_query = (query: string, data: unknown) =>
...
const render_component_with_query = (args: ComponentConfig, instance_args: ComponentArgs, selection: D3Selection,
  element: D3Selection) => (data: unknown) =>
  with_spinner(selection)(
    execute_query(instance_args.query as string, data)(
