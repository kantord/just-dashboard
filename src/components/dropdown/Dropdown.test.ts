...
describe('Text component', () => {
  ...
  it('should throw on invalid variable name', () => {
    expect(() => { (DropdownComponent({'variable': 'foo bar', 'default': null} as any) as any)()(undefined as any) })
      .toThrow('Argument \'variable\' is invalid')
  })

  it('requires default value', () => {
    expect(() => { (DropdownComponent({'variable': 'foobar'} as any) as any)()(undefined as any) })
