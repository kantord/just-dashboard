...
describe('Root component', () => {
  ...
  it('variables are initialized in state', () => {
    ...
    call_render_with({
      'parser': (component: any) => () => component.args.state_handler.init_variable(
  ...
  it('calls state_handler\'s reset', () => {
    ...
    call_render_with({
      ...
      'render_args': [
        { 'component': 'dropdown', 'args': {
          'default': sinon.spy(), 'variable': 'foo',
        }, 'data': [] }
      ]
    })
  ...
  it('variables are updated in state', () => {
    ...
    call_render_with({
      'parser': (component: any) => () => component.args.state_handler.set_variable(
        component.args.variable, component.args.default),
      'component_args': {'title': 'x', 'state_handler': state_handler},
      'render_args': [
        { 'component': 'dropdown', 'args': {
