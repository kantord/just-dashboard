...
describe('Parser', () => {
  ...
  it('should throw error when argument is not an object', () => {
    expect(() => {
      ;(parse as any)()(42 as any)
    }).toThrow('An object is required')
  })

  it('should throw when component name is invalid', () => {
    expect(() => {
      ;(parse as any)()({ component: 'bullshit component name' })
  ...
  it('passes file_loader to root', () => {
    ...
    const component = parse(fake_component_loader)({ component: 'root', args: { title: '' } }, my_file_loader as any)
    component(my_selection as any)
    expect(
      fake_component.calledWith({
        title: '',
